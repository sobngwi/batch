...
import org.sobngwi.schema.Revision;
...
import org.sobngwi.schema.util.HtmlEncoder;
...
public class HtmlFormatter {
    ...
    protected void writeHeader(Database db, Table table, String text, List<String> javascript, LineWriter out) throws IOException {
        ...
        out.writeln("</td>");
        out.writeln("  <td class='heading' align='right' valign='top' title='John Currier - Creator of Cool Tools'><span class='indent'></span><br><span class='indent'><span class='signature'><a href='http://www.sobngwi.org' target='_blank'></a></span></span></td>");
        out.writeln(" </tr>");
        out.writeln("</table>");
    }
