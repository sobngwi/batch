...
public class RegularExpressionLineMapper implements LineMapper<Object>,
		InitializingBean {
	...
	/**
	 * RegularExpressionLineMapper is a basic implementation of the LineMapper interface. 
	 * It implements the one required method, mapLine, to convert 
	 * a String read in from a flat file to an object.
	 * use LineTokenizer implementation to parse the String into a FieldSet.
	 * @return
	...
	public void setFieldSetMappers(
			Map<String, FieldSetMapper<Object>> fieldSetMappers) {
	...
	private LineTokenizer findTokenizer(String input) {
		...
		if (tokenizer != null) {
			...
			throw new ParseException("Unable to locate a tokenizer for "
					+ input);
		}
	}
